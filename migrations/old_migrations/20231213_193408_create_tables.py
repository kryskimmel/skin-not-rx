...
Revision ID: 1e0f0b90ace5
Revises:
Create Date: 2023-12-13 19:34:08.219823
...
def upgrade() -> None:
    ...
    sa.Column('hashed_password', sa.Text(length=255), nullable=False),
    sa.Column('profile_image', sa.Text(length=255), nullable=False),
    sa.Column('skin_type', sa.Text(length=255), nullable=False),
    ...
    sa.Column('skin_concern', sa.Text(length=255), nullable=False),
    ...
    sa.Column('image_url', sa.Text(length=255), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['product_id'], ['products.id'], ),
    sa.PrimaryKeyConstraint('id')
