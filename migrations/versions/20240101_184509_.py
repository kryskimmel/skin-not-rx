...
Revision ID: 8c5b96310a48
Revises: 
Create Date: 2024-01-01 18:45:09.244949
...
def upgrade() -> None:
    ...
    op.create_table('collections_products',
...
def downgrade() -> None:
    ...
    op.drop_table('collections_products')
