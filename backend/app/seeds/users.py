...
def seed_users():
    demo = User(
        first_name='Demo', last_name='Lition', username='demo', email='demo@aa.io', password='password', profile_image='https://upload.wikimedia.org/wikipedia/commons/thumb/e/e0/SNice.svg/1920px-SNice.svg.png', skin_type='Dry')
    vanessa = User(
    ...
    yasmin = User(
        first_name='Yasmin', last_name='Anderson', username='yasmin_xo', email='yasmin@gmail.com', password='password', profile_image='https://upload.wikimedia.org/wikipedia/commons/thumb/3/3a/Rosa_Precious_platinum.jpg/1920px-Rosa_Precious_platinum.jpg', skin_type='Acne-Prone')
